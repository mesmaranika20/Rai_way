...
# curl -X GET "https://super-space-disco-x57rvprjvpxqfp447-8000.app.github.dev/api/payroll"

# # CREATE PAYROLL RECORD
# curl -X POST "https://super-space-disco-x57rvprjvpxqfp447-8000.app.github.dev/api/payroll" \
# -H "Content-Type: application/json" \
# -d '{
#   "staff_id": 1,
#   "salary": 35000,
...
# # REGISTER USER
# curl -X POST "https://super-space-disco-x57rvprjvpxqfp447-8000.app.github.dev/api/auth/register" \
# -H "Content-Type: application/json" \
# -d '{
#   "username": "admin",
#   "password": "admin123"
...
# # LOGIN USER
# curl -X POST "https://super-space-disco-x57rvprjvpxqfp447-8000.app.github.dev/api/auth/login" \
# -H "Content-Type: application/json" \
# -d '{
#   "username": "admin",
#   "password": "admin123"
